...
<DemoPreview
  demoUrl="/other/radio-buttons/index.html"
  title="单选按钮组件"
  description="单选按钮样式与交互示例，适合作为表单控件视觉参考。"
/>
...
单选按钮样式与交互示例，适合作为表单控件视觉参考。

## 为什么值得看

- 单选按钮样式与交互示例，适合作为表单控件视觉参考。
- 它把 Form / Radio / Component 这类实现方式放在一个很容易上手的案例里。

## 技术要点

- 分类：其他效果
- 标签：Form / Radio / Component
- 场景：未补充
- 难度：初级
- 原始入口：
...
- [查看 GitHub 源码目录](https://github.com/Fridolph/my-program/tree/master/public/other/radio-buttons)
- [返回 其他效果 分类](../)
...
- 如果你正在做 其他效果 相关页面，可以先把它当成结构和反馈节奏的参考。
- 如果你只需要快速验证某种交互感觉，也适合先从这个案例抽最小可复用部分。

## 实现拆解

- 先看 Form 与 Radio 在这个案例里分别承担了什么角色。
...
<div class="browse-chip-list"><a class="browse-chip" href="/explore/tags/form">Form</a><a class="browse-chip" href="/explore/tags/radio">Radio</a><a class="browse-chip" href="/explore/tags/component">Component</a></div>
...
<div class="browse-nav-grid">
    <a class="browse-nav-card" href="/demos/other/background-pattern-1">
      <span>上一条</span>
      <strong>背景纹理效果</strong>
      <small>背景纹理实验示例，可作为页面氛围层或装饰层参考。</small>
    </a>
