...
<DemoPreview
  demoUrl="/jquery/image-preloading/index3.html"
  title="顺序图片预加载画廊"
  description="按顺序预加载图片并切换展示，适合对比不同图片加载策略。"
/>
...
按顺序预加载图片并切换展示，适合对比不同图片加载策略。

## 为什么值得看

- 按顺序预加载图片并切换展示，适合对比不同图片加载策略。
- 它把 Image / Preload / Sequence 这类实现方式放在一个很容易上手的案例里。

## 技术要点

- 分类：jQuery 特效
- 标签：Image / Preload / Sequence
- 场景：轮播预加载 / 逐步资源加载
- 难度：初级
- 原始入口：
  - `/jquery/image-preloading/index3.html`
...
- 适合在“轮播预加载”这类页面或模块里作为第一批参考案例。
- 适合在“逐步资源加载”这类页面或模块里作为第一批参考案例。
...
<div class="browse-chip-list"><a class="browse-chip" href="/explore/tags/image">Image</a><a class="browse-chip" href="/explore/tags/preload">Preload</a><a class="browse-chip" href="/explore/tags/sequence">Sequence</a></div>

### 按场景继续找

<div class="browse-chip-list"><a class="browse-chip" href="/explore/scenes/u8f6e-u64ad-u9884-u52a0-u8f7d">轮播预加载</a><a class="browse-chip" href="/explore/scenes/u9010-u6b65-u8d44-u6e90-u52a0-u8f7d">逐步资源加载</a></div>
