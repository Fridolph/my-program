...
<DemoPreview
  demoUrl="/animation-js/icon-toggle-animation/index.html"
  title="图标切换动画"
  description="通过图标形态切换表达状态变化，适合作为按钮反馈参考。"
/>
...
通过图标形态切换表达状态变化，适合作为按钮反馈参考。

## 为什么值得看

- 通过图标形态切换表达状态变化，适合作为按钮反馈参考。
- 它把 Icon / Toggle / Animation 这类实现方式放在一个很容易上手的案例里。

## 技术要点

- 分类：动画效果
- 标签：Icon / Toggle / Animation
- 场景：未补充
- 难度：初级
- 原始入口：
  - `/animation-js/icon-toggle-animation/index.html`
  - `animation-js/icon-toggle-animation`
...
- 先看 Icon 与 Toggle 在这个案例里分别承担了什么角色。
...
<div class="browse-chip-list"><a class="browse-chip" href="/explore/tags/icon">Icon</a><a class="browse-chip" href="/explore/tags/toggle">Toggle</a><a class="browse-chip" href="/explore/tags/animation">Animation</a></div>
