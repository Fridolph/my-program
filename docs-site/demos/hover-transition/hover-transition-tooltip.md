...
<DemoPreview
  demoUrl="/hover-transition/tooltip/index.html"
  title="Tooltip 提示层示例"
  description="功能较完整的 Tooltip 演示，适合作为提示层定位与样式参考。"
/>
...
功能较完整的 Tooltip 演示，适合作为提示层定位与样式参考。

## 为什么值得看

- 功能较完整的 Tooltip 演示，适合作为提示层定位与样式参考。
- 它把 Tooltip / Hover / CSS3 这类实现方式放在一个很容易上手的案例里。

## 技术要点

- 分类：CSS 过渡效果
- 标签：Tooltip / Hover / CSS3
- 场景：未补充
- 难度：中级
- 原始入口：
  - `/hover-transition/tooltip/index.html`
  - `hover-transition/tooltip`
...
- 先看 Tooltip 与 Hover 在这个案例里分别承担了什么角色。
...
<div class="browse-chip-list"><a class="browse-chip" href="/explore/tags/tooltip">Tooltip</a><a class="browse-chip" href="/explore/tags/hover">Hover</a><a class="browse-chip" href="/explore/tags/css3">CSS3</a></div>
