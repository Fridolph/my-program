...
<DemoPreview
  demoUrl="/hover-transition/transform-perspective/index.html"
  title="3D 视频透视展示"
  description="CSS3 3D 透视视频展示效果，适合作为空间感卡片与封面参考。"
/>
...
CSS3 3D 透视视频展示效果，适合作为空间感卡片与封面参考。

## 为什么值得看

- CSS3 3D 透视视频展示效果，适合作为空间感卡片与封面参考。
- 它把 3D / Perspective / Transform 这类实现方式放在一个很容易上手的案例里。

## 技术要点

- 分类：CSS 过渡效果
- 标签：3D / Perspective / Transform
- 场景：未补充
- 难度：高级
- 原始入口：
  - `/hover-transition/transform-perspective/index.html`
  - `hover-transition/transform-perspective`
...
- 先看 3D 与 Perspective 在这个案例里分别承担了什么角色。
...
<div class="browse-chip-list"><a class="browse-chip" href="/explore/tags/3d">3D</a><a class="browse-chip" href="/explore/tags/perspective">Perspective</a><a class="browse-chip" href="/explore/tags/transform">Transform</a></div>
