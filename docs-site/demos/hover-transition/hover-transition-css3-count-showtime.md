...
<DemoPreview
  demoUrl="/hover-transition/css3-count-showtime/index.html"
  title="数字翻转计数展示"
  description="CSS3 计数展示效果，适合作为数据面板或统计卡片的视觉参考。"
/>
...
CSS3 计数展示效果，适合作为数据面板或统计卡片的视觉参考。

## 为什么值得看

- CSS3 计数展示效果，适合作为数据面板或统计卡片的视觉参考。
- 它把 Counter / Animation / CSS3 这类实现方式放在一个很容易上手的案例里。

## 技术要点

- 分类：CSS 过渡效果
- 标签：Counter / Animation / CSS3
- 场景：未补充
- 难度：中级
- 原始入口：
  - `/hover-transition/css3-count-showtime/index.html`
  - `hover-transition/css3-count-showtime`
...
- 先看 Counter 与 Animation 在这个案例里分别承担了什么角色。
...
<div class="browse-chip-list"><a class="browse-chip" href="/explore/tags/counter">Counter</a><a class="browse-chip" href="/explore/tags/animation">Animation</a><a class="browse-chip" href="/explore/tags/css3">CSS3</a></div>
