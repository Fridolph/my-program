...
<DemoPreview
  demoUrl="/hover-transition/buttons-box-shadow/index.html"
  title="按钮阴影交互动效"
  description="通过 box-shadow 变化强化按钮 hover 态，适合做操作反馈参考。"
/>
...
通过 box-shadow 变化强化按钮 hover 态，适合做操作反馈参考。

## 为什么值得看

- 通过 box-shadow 变化强化按钮 hover 态，适合做操作反馈参考。
- 它把 Button / Shadow / Hover 这类实现方式放在一个很容易上手的案例里。

## 技术要点

- 分类：CSS 过渡效果
- 标签：Button / Shadow / Hover
- 场景：未补充
- 难度：初级
- 原始入口：
  - `/hover-transition/buttons-box-shadow/index.html`
  - `hover-transition/buttons-box-shadow`
...
- 先看 Button 与 Shadow 在这个案例里分别承担了什么角色。
...
<div class="browse-chip-list"><a class="browse-chip" href="/explore/tags/button">Button</a><a class="browse-chip" href="/explore/tags/shadow">Shadow</a><a class="browse-chip" href="/explore/tags/hover">Hover</a></div>
...
<div class="browse-nav-grid">
    <a class="browse-nav-card" href="/demos/hover-transition/hover-transition-transform-perspective">
      <span>上一条</span>
      <strong>3D 视频透视展示</strong>
      <small>CSS3 3D 透视视频展示效果，适合作为空间感卡片与封面参考。</small>
    </a>
