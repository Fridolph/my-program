...
<DemoPreview
  demoUrl="/hover-transition/text-hover/index.html"
  title="文字 Hover 效果集"
  description="文字 hover 效果集合，适合做标题强调与链接状态设计。"
/>
...
文字 hover 效果集合，适合做标题强调与链接状态设计。

## 为什么值得看

- 文字 hover 效果集合，适合做标题强调与链接状态设计。
- 它把 Text / Hover / Typography 这类实现方式放在一个很容易上手的案例里。

## 技术要点

- 分类：CSS 过渡效果
- 标签：Text / Hover / Typography
- 场景：未补充
- 难度：初级
- 原始入口：
  - `/hover-transition/text-hover/index.html`
  - `hover-transition/text-hover`
...
- 先看 Text 与 Hover 在这个案例里分别承担了什么角色。
...
<div class="browse-chip-list"><a class="browse-chip" href="/explore/tags/text">Text</a><a class="browse-chip" href="/explore/tags/hover">Hover</a><a class="browse-chip" href="/explore/tags/typography">Typography</a></div>
...
<div class="mini-card-grid">
    ...
    <a class="mini-card" href="/demos/hover-transition/hover-transition-buttons-box-shadow">
      <strong>按钮阴影交互动效</strong>
      <span>通过 box-shadow 变化强化按钮 hover 态，适合做操作反馈参考。</span>
    </a>
  </div>
