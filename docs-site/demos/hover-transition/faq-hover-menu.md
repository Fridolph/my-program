...
<DemoPreview
  demoUrl="/hover-transition/悬停菜单/index.html"
  title="问答式悬停菜单"
  description="用悬停切换问答内容的交互菜单，适合做信息分层展示。"
/>
...
用悬停切换问答内容的交互菜单，适合做信息分层展示。

## 为什么值得看

- 用悬停切换问答内容的交互菜单，适合做信息分层展示。
- 它把 Menu / Hover / Interaction 这类实现方式放在一个很容易上手的案例里。

## 技术要点

- 分类：CSS 过渡效果
- 标签：Menu / Hover / Interaction
- 场景：未补充
- 难度：中级
- 原始入口：
  - `/hover-transition/悬停菜单/index.html`
  - `hover-transition/悬停菜单`

## 在线体验

- [打开原始 Demo 页面](/hover-transition/悬停菜单/index.html)
- [查看 GitHub 源码目录](https://github.com/Fridolph/my-program/tree/master/public/hover-transition/悬停菜单)
- [返回 CSS 过渡效果 分类](../)
...
- 先看 Menu 与 Hover 在这个案例里分别承担了什么角色。
...
<div class="browse-chip-list"><a class="browse-chip" href="/explore/tags/menu">Menu</a><a class="browse-chip" href="/explore/tags/hover">Hover</a><a class="browse-chip" href="/explore/tags/interaction">Interaction</a></div>
