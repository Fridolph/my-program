...
<DemoPreview
  demoUrl="/hover-transition/card-hover/index.html"
  title="卡片 Hover 展示"
  description="信息卡片 hover 展示效果，适合学习图文卡片的动画组织。"
/>
...
信息卡片 hover 展示效果，适合学习图文卡片的动画组织。

## 为什么值得看

- 信息卡片 hover 展示效果，适合学习图文卡片的动画组织。
- 它把 Card / Hover / Showcase 这类实现方式放在一个很容易上手的案例里。

## 技术要点

- 分类：CSS 过渡效果
- 标签：Card / Hover / Showcase
- 场景：图文卡片展示
- 难度：初级
- 原始入口：
...
<div class="browse-chip-list"><a class="browse-chip" href="/explore/tags/card">Card</a><a class="browse-chip" href="/explore/tags/hover">Hover</a><a class="browse-chip" href="/explore/tags/showcase">Showcase</a></div>
