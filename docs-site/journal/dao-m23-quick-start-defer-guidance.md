...
# M23 开发笔记：让 quick start 开始表达当前先不上什么

- 日期：2026-03-28
- 类型：开发笔记
- 原始文档：`docs/blog/2026-03-28-vitepress-dao-m23-quick-start-defer-guidance.md`
...
<div class="browse-chip-list"><span class="browse-chip">quick start defer guidance</span><span class="browse-chip">follow-up</span><span class="browse-chip">discover</span><span class="browse-chip">decision</span></div>
...
为 quick start 补反向推进语义，让站点不只表达下一步该补什么，也开始表达当前先不上什么更稳。
