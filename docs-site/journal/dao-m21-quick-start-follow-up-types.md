...
# M21 开发笔记：让 quick start 的下一步开始区分推进类型

- 日期：2026-03-21
- 类型：开发笔记
- 原始文档：`docs/blog/2026-03-21-vitepress-dao-m21-quick-start-follow-up-types.md`
...
<div class="browse-chip-list"><span class="browse-chip">quick start follow-up types</span><span class="browse-chip">entry flow</span><span class="browse-chip">discover</span><span class="browse-chip">next step</span></div>
...
为 quick start 补推进类型元数据，并生成按推进类型回看的入口页，让下一步建议不只停在跳转链接。
