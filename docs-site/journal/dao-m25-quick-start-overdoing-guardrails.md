...
# M25 开发笔记：让 quick start 开始提醒哪里最容易做过头

- 日期：2026-03-28
- 类型：开发笔记
- 原始文档：`docs/blog/2026-03-28-vitepress-dao-m25-quick-start-overdoing-guardrails.md`
...
<div class="browse-chip-list"><span class="browse-chip">quick start guardrails</span><span class="browse-chip">overdoing</span><span class="browse-chip">tradeoff</span><span class="browse-chip">decision</span></div>
...
继续沿 quick start 主链路补“做过头”的提醒，让站点开始表达当前这条线最容易失控的地方。
