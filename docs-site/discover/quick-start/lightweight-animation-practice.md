---
layout: doc
title: 快速开始 · 我想先找低成本练习案例
description: 适合先从轻量动画、基础 transform 和小型组件反馈开始练手。
---

# 快速开始 · 我想先找低成本练习案例

适合先从轻量动画、基础 transform 和小型组件反馈开始练手。
...
- 适合：动效练手 / 组件试验 / 低成本改造
- 改造成本：低投入
- 第一版预期：当你能稳定复现一个清楚的小反馈，并说清楚它服务的内容对象时，这条线就已经有效。

## 按角色 / 阶段回看

### 适合角色

<div class="browse-chip-list"><a class="browse-chip" href="/discover/quick-start/roles/frontend-practice">前端练手</a><a class="browse-chip" href="/discover/quick-start/roles/component-experiment">组件试验</a></div>

### 当前阶段

<div class="browse-chip-list"><a class="browse-chip" href="/discover/quick-start/stages/validation">验证期</a></div>

## 为什么从这里开始

如果你现在更关心先做出一个稳定的小案例，而不是立刻进入复杂视觉，这条起步线更合适。
...
<div class="topic-card-grid">
    <a class="topic-card" href="/discover/spotlights/lightweight-ui-practice">
      ...
      <span>7 个场景 · 7 个 demo</span>
      <small>适合在基础动画教学、轻量组件反馈和小型 UI 演示中快速找到容易上手的练习入口。</small>
    </a>
  </div>
...
<div class="topic-card-grid">
    <a class="topic-card" href="/explore/scenes/u52a8-u753b-u57fa-u7840-u6559-u5b66">
      <strong>动画基础教学</strong>
      <span>1 个 demo</span>
      <small>适合在基础动画教学、组件动效入门和轻量练习中寻找最容易拆解的案例。</small>
    </a>
    <a class="topic-card" href="/explore/scenes/u53d8-u5f62-u6548-u679c-u901f-u67e5">
      <strong>变形效果速查</strong>
      <span>1 个 demo</span>
      <small>适合在 transform 选型和基础空间反馈判断中快速对比不同变形方式。</small>
    </a>
    <a class="topic-card" href="/explore/scenes/u6309-u94ae-u914d-u8272">
      <strong>按钮配色</strong>
      <span>1 个 demo</span>
      <small>当前有 1 个 demo 可以作为“按钮配色”场景的参考入口。</small>
    </a>
  </div>
...
<div class="mini-card-grid">
    ...
    <a class="mini-card" href="/demos/layout/flex-layout-guide">
      <strong>Flex 语法示例</strong>
      <span>Flex 布局语法演示页，适合作为基础属性学习索引。</span>
    </a>
...
<div class="topic-card-grid">
    <a class="topic-card" href="/discover/quick-start/hero-first-screen">
      ...
      <small>单点动效练熟之后，下一步通常会回到真实页面入口，比如首屏氛围或导航组织。</small>
    </a>
...
<div class="browse-chip-list"><a class="browse-chip" href="/discover/quick-start/follow-up/hero-atmosphere">补首屏氛围</a><a class="browse-chip" href="/discover/quick-start/follow-up/content-entry">补内容入口</a></div>

## 当前先不急着补什么

<div class="topic-card-grid">
    <a class="topic-card" href="/discover/quick-start/follow-up/feedback-flow">
      <strong>先不上 补反馈节奏</strong>
      <span>当前先不急着补</span>
      <small>如果你现在还只是在做低成本练手，先不要急着补阅读或加载反馈，因为这类反馈更依赖真实内容和等待过程。</small>
    </a>
  </div>
...
<div class="topic-card-grid">
    <a class="topic-card" href="/discover/quick-start/follow-up/hero-atmosphere">
      <strong>补首屏氛围 &gt; 补反馈节奏</strong>
      <span>当前推进取舍</span>
      <small>当练手结果准备接回真实页面时，先补首屏氛围会比先补反馈节奏更容易建立整体方向。</small>
    </a>
    <a class="topic-card" href="/discover/quick-start/follow-up/content-entry">
      <strong>补内容入口 &gt; 补反馈节奏</strong>
      <span>当前推进取舍</span>
      <small>如果你想把练手成果接进卡片或列表页面，先补内容入口会比先补反馈节奏更贴近真实业务结构。</small>
    </a>
  </div>
...
<div class="topic-card-grid">
    <a class="topic-card" href="/discover/quick-start/follow-up/micro-motion">
      ...
      <small>这一条线最容易做过头的，是在还没弄清楚反馈服务什么内容之前，就不断叠视觉效果。</small>
    </a>
    <a class="topic-card" href="/discover/quick-start/follow-up/feedback-flow">
      <strong>小心做过头：补反馈节奏</strong>
      <span>当前 guardrail</span>
      <small>如果当前还只是轻量练手，却过早补复杂反馈系统，很容易把练习范围做得失控。</small>
    </a>
  </div>
...
<div class="topic-card-grid">
    <a class="topic-card" href="/discover/quick-start/roles/frontend-practice">
      <strong>前端练手 视角</strong>
      <span>补首屏氛围 / 补内容入口</span>
      <small>如果你主要从前端练手视角继续推进，这一步更常见的是：补首屏氛围 / 补内容入口。</small>
    </a>
    <a class="topic-card" href="/discover/quick-start/roles/component-experiment">
      <strong>组件试验 视角</strong>
      <span>补首屏氛围 / 补内容入口</span>
      <small>如果你主要从组件试验视角继续推进，这一步更常见的是：补首屏氛围 / 补内容入口。</small>
    </a>
  </div>
...
<div class="topic-card-grid">
    <a class="topic-card" href="/discover/quick-start/stages/validation">
      <strong>验证期</strong>
      <span>补首屏氛围 / 补内容入口</span>
      <small>如果你当前处在验证期，继续推进时更适合优先判断：补首屏氛围 / 补内容入口。</small>
    </a>
  </div>
