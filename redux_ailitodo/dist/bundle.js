...
/***/ function(module, exports, __webpack_require__) {
	...
	let React = __webpack_require__(149);
	let Provider = __webpack_require__(161).Provider;
	let createStore = __webpack_require__(168).createStore;
	let todoApp = __webpack_require__(183).todoApp;
	let App = __webpack_require__(186).App;
	{
	    __webpack_require__(192);
	    __webpack_require__(196);
	    let store = createStore(todoApp);
	    reactDom.render(React.createElement(Provider, { store: store }, React.createElement(App, null)), document.getElementById('con'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	let combineReducers = __webpack_require__(168).combineReducers;
	let TodoActionType = __webpack_require__(184).TodoActionType;
	let TodoFilterType = __webpack_require__(184).TodoFilterType;
	let VisibilityFilters = __webpack_require__(184).VisibilityFilters;
	//let { ADD_TODO, DELETE_TODO, COMPLETE_TODO, CLEAR_COMPLETED, SET_VISIBILITY_FILTER, VisibilityFilters } = require('../actions/action');
	let utils = __webpack_require__(185).utils;
...
/***/ function(module, exports) {
	...
	let addTodo = function (text) {
	    return { type: TodoActionType.ADD_TODO, text: text };
	};
	let deleteTodo = function (id) {
	    return { type: TodoActionType.DELETE_TODO, id: id };
	};
	let completeTodo = function (id) {
	    return { type: TodoActionType.COMPLETE_TODO, id: id };
	};
	let clearCompleteTodo = function () {
	    return { type: TodoActionType.CLEAR_COMPLETED };
	};
	let setVisibilityFilter = function (filter) {
	    return { type: TodoFilterType.SET_VISIBILITY_FILTER, filter: filter };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	let React = __webpack_require__(149);
	let connect = __webpack_require__(161).connect;
	let $__0 = __webpack_require__(184),
	    addTodo = $__0.addTodo,
	    deleteTodo = $__0.deleteTodo,
	    completeTodo = $__0.completeTodo,
	    clearCompleteTodo = $__0.clearCompleteTodo,
	    setVisibilityFilter = $__0.setVisibilityFilter,
	    VisibilityFilters = $__0.VisibilityFilters;
	let FooterOuter = __webpack_require__(187).FooterOuter;
	let Footer = __webpack_require__(188).Footer;
	let Header = __webpack_require__(190).Header;
	let TodoItem = __webpack_require__(191).TodoItem;
	{
	    let App = React.createClass({ displayName: "App",
	        render: function () {
	            const $__0 = this.props,
	                  dispatch = $__0.dispatch,
	                  visibleTodos = $__0.visibleTodos,
	                  visibilityFilter = $__0.visibilityFilter;
	            console.log(this.props);
	            let TodoItems = visibleTodos.map(function (todo) {
	                return React.createElement(TodoItem, {
	                    todo: todo,
	                    onClickDelete: function (id) {
	                        return dispatch(deleteTodo(id));
	                    },
	                    onClickToggle: function (id) {
	                        return dispatch(completeTodo(id));
	                    } });
	            });
	            return React.createElement("section", { id: "todoapp", className: "todoapp" }, React.createElement(Header, { onClickAdd: function (text) {
	                    return dispatch(addTodo(text));
	                } }), React.createElement("section", { id: "main", className: "main" }, React.createElement("input", { id: "toggle-all", className: "toggle-all", type: "checkbox" }), React.createElement("label", { htmlFor: "toggle-all" }, "Mark all as complete"), React.createElement("ul", { id: "todo-list", className: "todo-list" }, TodoItems)), React.createElement(Footer, {
	                ...
	                onClearCompleted: function () {
	                    return dispatch(clearCompleteTodo());
	                } }));
	        }
	    });

	    /*
	     * 在注入store之前,对所注入的state进行过滤
	     * */
...
/***/ function(module, exports, __webpack_require__) {
	...
	let React = __webpack_require__(149);
	{
	    let FooterOuter = React.createClass({ displayName: "FooterOuter",
	        render: function () {
	            return React.createElement("footer", { id: "info", className: "info" }, React.createElement("p", null, "Double-click to edit a todo"), React.createElement("p", null, "Created by ", React.createElement("a", { href: "http://sindresorhus.com" }, "Sindre Sorhus")), React.createElement("p", null, "Part of ", React.createElement("a", { href: "http://todomvc.com" }, "TodoMVC")));
	        }
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	let React = __webpack_require__(149);
	let classNames = __webpack_require__(189);
	let $__0 = __webpack_require__(184),
	    VisibilityFilters = $__0.VisibilityFilters;
	{
	    let Footer = React.createClass({ displayName: "Footer",
	        ...
	        render: function () {
	            let $__0 = this.props,
	                count = $__0.count,
	                visibilityFilter = $__0.visibilityFilter;
	            return React.createElement("footer", { id: "footer", className: "footer" }, React.createElement("span", { id: "todo-count", className: "todo-count" }, React.createElement("strong", {
	                id: "totale" }, count), " 项任务"), React.createElement("ul", { id: "filters", className: "filters" }, React.createElement("li", null, React.createElement("a", { className: classNames({
	                    selected: visibilityFilter == VisibilityFilters.SHOW_ALL
	                }), href: "javascript:void(0)", id: "all",
	                onClick: this.handleFilterAll }, "显示全部")), React.createElement("li", null, React.createElement("a", { className: classNames({
	                    selected: visibilityFilter == VisibilityFilters.SHOW_ACTIVE
	                }), href: "javascript:void(0)", id: "active",
	                onClick: this.handleFilterActive }, "未完成")), React.createElement("li", null, React.createElement("a", { className: classNames({
	                    selected: visibilityFilter == VisibilityFilters.SHOW_COMPLETED
	                }), href: "javascript:void(0)", id: "completed",
	                onClick: this.handleFilterCompleted }, "已完成"))), React.createElement("button", { id: "clear-completed", className: "clear-completed",
...
/***/ function(module, exports, __webpack_require__) {
	...
	let React = __webpack_require__(149);
	{
	    ...
	    let Header = React.createClass({ displayName: "Header",
	        ...
	        render: function () {
	            console.log(this.props);
	            return React.createElement("header", { id: "header" }, React.createElement("h1", null, "todos"), React.createElement("input", {
	                ref: "new-todo",
	                className: "new-todo",
...
/***/ function(module, exports, __webpack_require__) {
	...
	let classNames = __webpack_require__(189);
	{
	    let TodoItem = React.createClass({ displayName: "TodoItem",
	        ...
	        render: function (a) {
	            return React.createElement("li", { className: classNames({
	                ...
	                }) }, React.createElement("div", { className: "view" }, React.createElement("input", { className: "toggle", type: "checkbox",
	                onChange: this.handleToggle,
	                checked: this.props.todo.completed }), React.createElement("label", null, this.props.todo.text), React.createElement("button", { className: "destroy", onClick: this.handleDestroy })), React.createElement("input", { className: "edit", value: this.props.todo.text }));
	        }
	    });
